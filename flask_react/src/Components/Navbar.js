...
const useStyles = makeStyles({
  root: {
    ...
    padding: "0 30px",
    textShadow:
      "0 1px 0 #ccc, 0 2px 0 #c9c9c9, 0 3px 0 #bbb, 0 4px 0 #b9b9b9, 0 5px 0 #aaa, 0 6px 1px rgba(0,0,0,.1), 0 0 5px rgba(0,0,0,.1), 0 1px 3px rgba(0,0,0,.3), 0 3px 5px rgba(0,0,0,.2), 0 1px 10px rgba(0,0,0,.25), 0 10px 10px rgba(0,0,0,.2), 0 20px 20px rgba(0,0,0,.15)",
  },
});
    ...
    return (
      <Box>
        <MenuItem
          key={page}
          disablePadding
          sx={{ flexGrow: 1, mr: 1, display: { xs: "none", md: "flex" } }}
        >
          <Link to={link} style={{ textDecoration: "none" }}>
            <Button sx={{ color: "white", textAlign: "left" }}>
              {page}
          ...
          <Box sx={{ flexGrow: 0, marginLeft: "auto" }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar sx={{ bgcolor: "#727dff" }} src={Ava} />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: "45px" }}
